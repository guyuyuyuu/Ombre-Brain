...
Debug surfaces should expose the same runtime decision. `inspect_moments`, `/api/moments`, `inspect_diffusion`, `/api/diffusion-debug`, `/api/breath-debug`, and Gateway injection debug include:
